    ...
    <div className="flex flex-col items-center justify-center h-screen gap-8">
      ...
      <div className="grid grid-cols-4 sm:grid-cols-4 gap-6">
        ...
        <Link href='/home'>
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6 text-center text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
            <div className="space-y-2">
              <h3 className="text-2xl font-bold">Exporter</h3>
        ...
        <Link href='/home'>
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6 text-center text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
            <div className="space-y-2">
              <h3 className="text-2xl font-bold">Insurace</h3>
              <p>Fasal / Krisi Bima</p>
            </div>
          </div>
          <img
            alt="Card 2"
        ...
        <Link href='/home'>
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6 text-center text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
            <div className="space-y-2">
              <h3 className="text-2xl font-bold">Fertilizer Company</h3>
              <p>Fertilizer/Pesticides</p>
            </div>
          </div>
          <img
            alt="Card 3"
